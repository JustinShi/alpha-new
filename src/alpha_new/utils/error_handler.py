...
class ErrorHandler:
    ...
    ERROR_KEYWORDS = {
        ...
        ErrorType.NETWORK_TIMEOUT: [
            "timeout", "连接超时", "网络超时", "connection timeout", "read timeout"
        ],
    ...
    def __init__(self):
        ...
        self.last_error_time: Dict[ErrorType, float] = {error_type: 0 for error_type in ErrorType}
    ...
    def get_error_stats(self) -> Dict[str, Any]:
        ...
        for error_type in ErrorType:
            stats[error_type.value] = {
                ...
                "time_since_last": time.time() - self.last_error_time[error_type] if self.last_error_time[error_type] > 0 else None
            }
        return stats
    
    async def handle_error(self, error: Exception, user_id: int, context: Dict[str, Any]) -> Dict[str, Any]:
        """处理错误并返回处理结果"""
    ...
    async def _handle_insufficient_balance(self, error: Exception, user_id: int, context: Dict[str, Any]) -> Dict[str, Any]:
        """处理余额不足错误"""
    ...
    async def _handle_network_timeout(self, error: Exception, user_id: int, context: Dict[str, Any]) -> Dict[str, Any]:
        """处理网络超时错误"""
    ...
    async def _handle_rate_limit(self, error: Exception, user_id: int, context: Dict[str, Any]) -> Dict[str, Any]:
        """处理API限流错误"""
    ...
    async def _handle_invalid_order(self, error: Exception, user_id: int, context: Dict[str, Any]) -> Dict[str, Any]:
        """处理无效订单错误"""
    ...
    async def _handle_order_not_found(self, error: Exception, user_id: int, context: Dict[str, Any]) -> Dict[str, Any]:
        """处理订单不存在错误"""
    ...
    async def _handle_websocket_disconnect(self, error: Exception, user_id: int, context: Dict[str, Any]) -> Dict[str, Any]:
        """处理WebSocket断开错误"""
    ...
    async def _handle_api_error(self, error: Exception, user_id: int, context: Dict[str, Any]) -> Dict[str, Any]:
        """处理API服务器错误"""
    ...
    async def _handle_unknown_error(self, error: Exception, user_id: int, context: Dict[str, Any]) -> Dict[str, Any]:
        """处理未知错误"""
        ...
        for attempt in range(self.max_retries + 1):
            try:
                ...
                if attempt == self.max_retries:
                    # 最后一次尝试失败，记录错误并抛出
                    await self.error_handler.handle_error(e, 0, {"function": func.__name__})
                    raise
